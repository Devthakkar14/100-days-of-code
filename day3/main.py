...
if I=="left":
    ...
    if C=="wait":
        print("The boat wasnt safe. Game Over.")
    else:
        F = input("You arrive at the island unharmed. There is a house with 3 doors. One red, one yellow and one blue. Which colour do you choose?")
        if F =="red":
            print("Its a room full of fire. Game Over.")
        elif F=="blue":
            print("You got the treasure!")
        elif F=="yellow":
            print("You found a room full of spiders. Game Over")
        else:
